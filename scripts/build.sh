...
java -jar $SCANNER -Dsonar.projectKey=$sq_prj -sonar.organization=$sq_org -Dsonar.host.url=https://sonarcloud.io -Dsonar.qualitygate.wait=true -Dsonar.java.binaries=target/classes
